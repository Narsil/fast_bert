.PHONY: docker
docker-cpu:
	docker build -f docker/Dockerfile . -t fast_bert --load
release-cpu:
	docker build -f docker/Dockerfile . -t registry.internal.huggingface.tech/api-inference/community:fast_bert-3 --push
docker-gpu:
